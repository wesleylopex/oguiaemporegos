<div id="description-form-modal" class="slickModal">
  <div class="window rounded-sm p-8">
    ...
    <form id="description-form" action="<?= base_url('candidates/profile/description/save') ?>" method="post" class="grid grid-cols-1 gap-4">
      <div>
        ...
        <textarea required maxlength="200" name="description" rows="4" class="input"><?= $candidate->description ?></textarea>
