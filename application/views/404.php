      ...
      <div class="h-full grid grid-cols-1 lg:grid-cols-3">
        <div class="lg:col-span-1 bg-primary p-12">
          ...
          <h1 class="mt-14 lg:mb-14 font-medium text-xl md:text-2xl leading-relaxed md:leading-relaxed text-white">
            Ops! Parece que a página que você procurou <span class="text-secondary">não existe.</span>
          </h1>
          <a href="https://storyset.com" target="_blank" rel="noopener noreferrer">
            <figure class="hidden lg:block">
              <img class="w-4/5" src="<?= base_url('assets/site/images/illustrations/404-error-cuate.svg') ?>" loading="lazy" alt="Illustration forgot password svg" title="Illustration forgot password svg">
            </figure>
          </a>
        </div>
        <div class="lg:col-span-2 p-10 lg:p-0 flex items-center justify-center">
          <div class="xl:w-2/5 bg-white shadow-md rounded-sm p-6">
            <h1 class="text-gray-800 font-medium text-xl">Página não encontrada</h1>
            <p class="text-gray-600 paragraph text-sm mt-4">
              A página que você procurou <span class="font-medium">não está mais no ar</span>.
            </p>
            <p class="text-gray-600 paragraph text-sm my-4">Se você acha que foi um erro, entre em contato com a gente.</p>
            <a href="<?= base_url() ?>">
              <button class="btn btn--primary w-full">Voltar ao início</button>
            </a>
          </div>
        </div>
      </div>
