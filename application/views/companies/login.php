      ...
      <div class="h-full grid grid-cols-1 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2 p-10 lg:p-0 flex items-center justify-center">
          <div class="xl:w-2/5 bg-white shadow-md rounded-sm p-6">
            <h1 class="text-gray-900 font-medium text-xl leading-relaxed md:leading-relaxed">Login para empresas</h1>
            <p class="paragraph text-sm mt-1">Ainda não possui cadastro? <a target="_blank" href="https://api.whatsapp.com/send?phone=+5554996727875&text=Olá, gostaria de criar uma conta no site O Guia Empregos para a minha empresa" class="text-blue-600 hover:underline">Fale com a gente</a></p>
            <form action="<?= base_url('companies/login/login') ?>" method="post" class="mt-10 grid grid-cols-1 gap-6">
              <div>
              ...
              <div>
                <div class="flex items-center justify-between">
                  ...
                  <a href="<?= base_url('esqueceu-senha?type=companies') ?>" class="hover:underline text-sm block text-blue-600">Esqueceu a senha?</a>
                </div>
