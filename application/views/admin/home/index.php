												...
												<table class="table">
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img src="../assets/img/flags/id.png" loading="lazy" alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../assets/img/flags/us.png" loading="lazy" alt="united states">
																</div>
															</td>
															<td>USA</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../assets/img/flags/au.png" loading="lazy" alt="australia">
																</div>
															</td>
															<td>Australia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../assets/img/flags/ru.png" loading="lazy" alt="russia">
																</div>
															</td>
															<td>Russia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../assets/img/flags/cn.png" loading="lazy" alt="china">
																</div>
															</td>
															<td>China</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="../assets/img/flags/br.png" loading="lazy" alt="brazil">
																</div>
															</td>
															<td>Brasil</td>
															<td class="text-right">
						...
						<div class="col-md-4">
							<div class="card card-round">
								<div class="card-body">
									...
									<div class="card-list">
										<div class="item-list">
											<img src="../assets/img/jm_denis.jpg" loading="lazy" alt="denis" class="small-pic">
										...
										<div class="item-list">
											<img src="../assets/img/chadengle.jpg" loading="lazy" alt="chad" class="small-pic">
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<img src="../assets/img/mlane.jpg" loading="lazy" alt="john doe" class="small-pic">
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<img src="../assets/img/talha.jpg" loading="lazy" alt="talha" class="small-pic">
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<img src="../assets/img/sauro.jpg" loading="lazy" alt="sauro" class="small-pic">
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<img src="../assets/img/arashmil.jpg" loading="lazy" alt="arash mil" class="small-pic">
											<div class="info-user ml-3">
									...
									<div class="quick-content contact-content">
										...
										<div class="contact-list contact-list-recent">
											<div class="user">
												<a href="#">
													<div class="user-image">
														<img src="../assets/img/jm_denis.jpg" loading="lazy" alt="denis">
											...
											<div class="user">
												<a href="#">
													<div class="user-image">
														<img src="../assets/img/chadengle.jpg" loading="lazy" alt="chad">
											...
											<div class="user">
												<a href="#">
													<div class="user-image">
														<img src="../assets/img/mlane.jpg" loading="lazy" alt="john doe">
										...
										<div class="contact-list">
											...
											<div class="user">
												<a href="#">
													<div class="user-image">
														<img src="../assets/img/talha.jpg" loading="lazy" alt="talha">
														<span class="status offline"></span>
													</div>
													<div class="user-data2">
					...
					<div class="switch-block mt-3">
						...
						<div class="row images-pick m-0 mt-3 mb-5">
							<div class="col-4 col-md-3 img-pick active">
								<img src="../assets/img/sidebar-images/1.jpg" loading="lazy" alt="sidebar background">
							</div>
							<div class="col-4 col-md-3 img-pick">
								<img src="../assets/img/sidebar-images/2.jpg" loading="lazy" alt="sidebar background">
							</div>
							<div class="col-4 col-md-3 img-pick">
								<img src="../assets/img/sidebar-images/3.jpg" loading="lazy" alt="sidebar background">
							</div>
							<div class="col-4 col-md-3 img-pick">
								<img src="../assets/img/sidebar-images/4.jpg" loading="lazy" alt="sidebar background">
							</div>
							<div class="col-4 col-md-3 img-pick">
								<img src="../assets/img/sidebar-images/5.jpg" loading="lazy" alt="sidebar background">
							</div>
							<div class="col-4 col-md-3 img-pick">
								<img src="../assets/img/sidebar-images/6.jpg" loading="lazy" alt="sidebar background">
							</div>
							<div class="col-4 col-md-3 img-pick">
								<img src="../assets/img/sidebar-images/7.jpg" loading="lazy" alt="sidebar background">
							</div>
						</div>
					</div>
				</div>
